...
function transition5to3() {
    ...
    MapsTL.add(TweenMax.to("#mapLeft1Container", 0.7, {ease: Power2.easeInOut, left: 295, delay: -0.3}))
...
function transition3to5() {
    ...
    MapsTL.add(TweenMax.to("#mapLeft2Container", 0.7, {left: 125, opacity: 1, delay: -0.1}))
...
function transition3to7() {
    ...
    MapsTL.add(TweenMax.to("#mapLeft2Container", 0.7, {left: 365, opacity: 1, delay: -0.1}))
...
function transition7to5() {
    MapsTL.add(TweenMax.to("#mapLeft3Container", 0.7, {ease: Power2.easeInOut,ease: Power2.easeInOut, left: 100, opacity: 0}))
    MapsTL.add(TweenMax.to("#mapRight3Container", 0.7, {ease: Power2.easeInOut, right: 100, opacity: 0, delay: -0.7}))
    MapsTL.add(TweenMax.to("#mapLeft2Container", 0.7, {ease: Power2.easeInOut, left: 125, delay: -0.3}))
...
function transition5to7() {
    ...
    MapsTL.add(TweenMax.to(".mapImage", 0.7, {right: -425, ease: Power2.easeInOut, delay: -0.7}));
    MapsTL.add(TweenMax.to(".modeText", 0.7, {attr:{"max-width":210}, width: 220, ease: Power2.easeInOut, delay: -0.7}))
    MapsTL.add(TweenMax.to("#mapLeft3Container", 0.7, {left: 125, opacity: 1, delay: -0.1}))
    MapsTL.add(TweenMax.to("#mapRight3Container", 0.7, {right: 125, opacity: 1, delay: -0.7}));
...
function animate3Maps(bool) {
    if (bool) {
        MapsTL.add(TweenMax.to("#mapLeft1Container", 1, {ease: Power2.easeIn, top: -730}))
        MapsTL.add(TweenMax.to("#mapMiddleContainer", 1, {ease: Power2.easeIn, top: -730, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapRight1Container", 1, {ease: Power2.easeIn, top: -730, delay: -0.8}))
...
function animate5Maps(bool) {
    if (bool) {
        MapsTL.add(TweenMax.to("#mapLeft2Container", 1, {ease: Power2.easeIn, top: -730}))
        MapsTL.add(TweenMax.to("#mapLeft1Container", 1, {ease: Power2.easeIn, top: -730, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapMiddleContainer", 1, {ease: Power2.easeIn, top: -730, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapRight1Container", 1, {ease: Power2.easeIn, top: -730, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapRight2Container", 1, {ease: Power2.easeIn, top: -730, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapLeft3Container", 0, {ease: Power2.easeIn, top: -730}))
        MapsTL.add(TweenMax.to("#mapRight3Container", 0, {ease: Power2.easeIn, top: -730}));
    } else {
        MapsTL.add(TweenMax.to(["#backgroundIMG", "#stars"], 0.8, {ease: Power2.easeOut, top: 0}))
        ...
        MapsTL.add(TweenMax.to("#mapMiddleContainer", 1, {top: 53, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapRight1Container", 1, {top: 53, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapRight2Container", 1, {top: 53, delay: -0.8}))
        MapsTL.add(TweenMax.to("#mapLeft3Container", 0, {ease: Power2.easeIn, top: 53}))
        MapsTL.add(TweenMax.to("#mapRight3Container", 0, {ease: Power2.easeIn, top: 53}));
    }
}
